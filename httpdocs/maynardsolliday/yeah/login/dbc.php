...
define ("DB_HOST", "50.63.228.112"); // set database host
define ("DB_USER", "int651"); // set database user
define ("DB_PASS","Password12"); // set database password
define ("DB_NAME","int651"); // set database name
